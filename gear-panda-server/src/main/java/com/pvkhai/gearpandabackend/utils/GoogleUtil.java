package com.pvkhai.gearpandabackend.utils;
...
public class GoogleUtil {
        ...
        public UserDetails buildUser(GooglePojo googlePojo) {
            ...
            UserDetails userDetail = (UserDetails) new User(googlePojo.getEmail(),"","","",
                    "","",20L,"",null,1L,  Arrays.asList(new Roles(authorities.toString())));
            return userDetail;
        }
    }
